namespace DigitalisNyomozo
{
    internal class Program
    {
        ...
        static void UgyekAlMenu(AdatTar tar)
        {
            ...
            do
            {
                ...
                switch (opcio)
                {
                    ...
                    case 5:
                        Fejlec("Bizonyíték hozzárendelése");

                        if (tar.bizonyitekok.Count == 0)
                        {
                            Console.WriteLine("Nincsenek bizonyítékok.");
                            Console.ReadKey();
                        ...
                        List<string> ugyek4 = new List<string>();
                        List<string> bizonyitekok = new List<string>();

                        foreach (Ugy ugy3 in tar.ugyek)
                        {
                            ugyek4.Add($"{ugy3.azonosito} {ugy3.cim} - {ugy3.allapot}");
                        }

                        foreach (Bizonyitek bizonyitek in tar.bizonyitekok)
                        {
                            bizonyitekok.Add($"{bizonyitek.Azonosito} {bizonyitek.Tipus}, megbízhatóság: {bizonyitek.MegbizhatosagiErtek}/5");
                        }

                        int valasztasUgy3 = ValasztasLista(ugyek4);

                        Fejlec("Bizonyíték hozzárendelése");

                        int valasztasBizonyitek = ValasztasLista(bizonyitekok);

                        Fejlec("Bizonyíték hozzárendelése");

                        Console.WriteLine(tar.ugyek[valasztasUgy3].ToString() + "\n");
                        Console.WriteLine(tar.bizonyitekok[valasztasBizonyitek]);
                        Console.Write("\nHelyes? (i/n) ");
                        ...
                        if (key6 == 'i')
                        {
                            tar.ugyek[valasztasUgy3].bizonyitekok.Add(tar.bizonyitekok[valasztasBizonyitek]);

                            Console.WriteLine("\n> Bizonyíték hozzárendelése sikeres.");
                        }
                        else
                        {
                            Console.WriteLine("\n> Bizonyíték hozzárendelése megszakítva.");
                        }
        ...
        static void BizonyitekokAlMenu(AdatTar tar)
        {
            string[] menuOpciok = { "Listázás", "Felvétel", "Törlés", "Visszalépés" };
            int opcio;
            ...
            do
            {
                ...
                {
                    case 0:
                        Fejlec("Bizonyítékok listázása");

                        foreach (Bizonyitek bizonyitek in tar.bizonyitekok)
                        {
                            Console.WriteLine(bizonyitek.ToString());
                        }
                    ...
                    case 1:
                        ...
                        do
                        {
                            ...
                            string megbizhatosagString = Console.ReadLine();

                            int.TryParse(megbizhatosagString, out megbizhatosag);
                        } while (megbizhatosag < 1 || megbizhatosag > 5);

                        Bizonyitek felvett = new Bizonyitek(azonosito, tipus, leiras, megbizhatosag);

                        Fejlec("Bizonyíték felvétele");

                        Console.WriteLine(felvett);
                        Console.Write("\nHelyes? (i/n) ");
                        ...
                        if (key1 == 'i')
                        {
                            tar.bizonyitekok.Add(felvett);
                            Console.WriteLine("\n> Bizonyíték hozzáadása sikeres.");
                        }
                        else
                        {
                            Console.WriteLine("\n> Bizonyíték hozzáadása megszakítva.");
                        }
                    ...
                    case 2:
                        ...
                        int valasztas = ValasztasLista(bizonyitekok);

                        Fejlec("Bizonyíték törlése");
                        Console.WriteLine($"{tar.bizonyitekok[valasztas]}\n");
                        ...
                        if (key2 == 'i')
                        {
                            tar.bizonyitekok.RemoveAt(valasztas);
                            Console.WriteLine("\n> A bizonyíték eltávolítása sikeres.");
                        }
                        else
                        {
                            Console.WriteLine("\n> A bizonyíték eltávolítása megszakítva.");
                        }
